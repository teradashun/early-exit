...
from simulations.resnet import ResNet, ResNet6n2
...
class ExitBlock(nn.Module):
    ...
    """
    def __init__(self, inplanes, num_classes, input_shape, exit_type, actual_inplanes=None):
    ...
    * input_shape:        Input shape of the model according to dataset.
    ...
    def add_exit_block(self, exit_type, total_flops):
        ...
        * total_flops:   the total FLOPs of the counterpart model.
        ...
        self.exits.append(ExitBlock(inplanes, self.num_classes, self.input_shape, exit_type, actual_inplanes=actual_inplanes))
    ...
    def forward(self, x, exit_threshold=None):
        ...
        for idx, exitblock in enumerate(self.exits):
            ...
            if not self.training and conf.item() > exit_threshold[idx]:
