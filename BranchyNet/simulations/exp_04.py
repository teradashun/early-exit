...
def run_inference(parent_dir, config, device):
    ...
    for ite in range(ite_num):
        ...
        if os.path.exists(model_path):
            ...
            test_thresholds = calculate_percentile_thresholds(model, val_loader, device, num_ee=num_ee, num_thresholds=exit_plot_num)
...
if __name__ == "__main__":
    ...
    pred_speed, final_acc = run_inference(parent_dir, config, device)
